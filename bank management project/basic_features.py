...
def check_loan_eligibility(cr, account_no):
    import datetime
    ...
    account_age_days = (datetime.datetime.now() - created_at).days
    ...
    last_tx_date = tx[0]
    days_since_last_tx = (datetime.datetime.now() - last_tx_date).days
